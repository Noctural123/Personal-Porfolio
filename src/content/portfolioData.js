...
export const PROJECTS = [
  ...
  },
  {
    ...
    description:
      'Simulated in-vehicle CAN bus traffic and attacks (injection, fuzzing) from 2.8M+ real F1 telemetry points. Built a 3-layer hybrid ML intrusion detection system (Isolation Forest, Random Forest) catching 100% of attacks, and exposed inflated single-run ML accuracy through cross-run evaluation — training on 4 runs, testing on unseen data.',
  ...
  },
  {
    ...
    imageLink: 'https://github.com/Noctural123/finance-dashboard',
    live: null,
    featured: false,
  },
  {
